...
// import { post as knxPartner } from "./posts/knx-partner-panama-automatizacion-premium"; // oculto hasta terminar la certificación KNX
...
export const blogPosts = [
  // knxPartner, // oculto hasta terminar la certificación KNX
  controlVoz,
  cortinasMotorizadas,
