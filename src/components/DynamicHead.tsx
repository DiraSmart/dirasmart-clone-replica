...
const FAQ_SCHEMA_ES = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "¿Qué es KNX y por qué importa?", acceptedAnswer: { "@type": "Answer", text: "KNX es el estándar mundial de automatización de edificios (ISO/IEC 14543-3), usado en más de 190 países. DiraSmart es uno de los pocos KNX Partners certificados en Panamá." } },
...
const FAQ_SCHEMA_EN = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "What is KNX and why does it matter?", acceptedAnswer: { "@type": "Answer", text: "KNX is the worldwide building automation standard (ISO/IEC 14543-3), used in over 190 countries. DiraSmart is one of the few certified KNX Partners in Panama." } },
