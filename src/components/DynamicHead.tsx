...
const PAGE_META_ES: Record<string, PageMeta> = {
  ...
  "/comercial": {
    ...
    description:
      "Automatización profesional y gestión de edificios (BMS) para hoteles, oficinas, museos, edificios y comercios en Panamá. KNX Partner certificado, integración BACnet, procesamiento local y soporte continuo. Solicita tu propuesta.",
  },
  "/blog": {
...
const PAGE_META_EN: Record<string, PageMeta> = {
  ...
  "/comercial": {
    ...
    description:
      "Professional automation and building management (BMS) for hotels, offices, museums, buildings and retail in Panama. Certified KNX Partner, BACnet integration, local processing and continuous support. Request a proposal.",
  },
  "/blog": {
